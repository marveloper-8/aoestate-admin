            ...
            <div className="mobile">
                ...
                <div className="properties-details-content">
                    ...
                    <div className="interested-people">
                        ...
                        <div className="head">Interested Brokers</div>

                        <div className="tab">
                            <p>Joshua Equere is interested in the 5 Bedroom Property</p>
                            <div className="buttons">
                                <button className="user-profile">VIEW USER</button>
                                <button className="property">VIEW PROPERTY</button>
                            </div>
                        </div>
